...
/* ============================================================================
   3. UNITS
   ========================================================================== */
const contrastCard = (a, b, body, callout) => ({
...
const UNITS = [
    ...
    },
    {
        ...
        review: [
            ...
            contrastCard(S.r, S.l, 'The whole difference is one question: does the tongue tip TOUCH the roof of your mouth? For /l/ yes, firmly. For /r/ no, never — and the lips round a little.', 'Say a long vowel /ɚ/ (as in "her") then speed it up: that is /r/. Now press the tip up: that is /l/.'),
            {
