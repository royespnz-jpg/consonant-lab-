...
const REPORT_URL = 'https://script.google.com/macros/s/AKfycbxEGNSXSpfeou2B42-VWKks4L9IpJEzPZWtMZoWdzpZW0Vn7iI40Kmo0oC-Q53HQ5_C/exec';
...
function report(unit: Unit | null, activity: string, score: number, correct: number, total: number): void {
...
function wireSettings(): void {
  ...
  $('#conn').addEventListener('click', async () => {
    ...
    const r = await postJson({
      ...
      score: 0, correct: 0, total: 0, engine: speaker.engine,
      at: new Date().toISOString(),
    });
    btn.disabled = false;
    if (r === 'ok') {
